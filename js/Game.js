class Game {
  ...
  start() {
    ...
    car1.scale = 0.07;
    car1.addImage( blastImage);
    car2 = createSprite(width / 2 + 100, height - 100);
    car2.addImage("car2", car2_img);
    car2.scale = 0.07;
    car2.addImage( blastImage);
    cars = [car1, car2];
    ...
    var obstacle2Positions = [
      { x: width / 2 + 250, y: height - 800, image: obstaculo1 },
      { x: width / 2 - 180, y: height - 2300, image: obstaculo1 },
      { x: width / 2 - 180, y: height - 2800, image: obstaculo1 },
     
      { x: width / 2 + 180, y: height - 3300, image: obstaculo1 },
      { x: width / 2 + 250, y: height - 3800, image: obstaculo1 },
      { x: width / 2 + 250, y: height - 4800, image: obstaculo1 },
      { x: width / 2 + 180, y: height - 5500, image: obstaculo1 },
    ]
   ...
   this.addSprites(obstaculo2,obstacle2Positions.length,obstaculo1,0.04,obstacle2Positions);
  }
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        var currentlift= allPlayers [plr].life;
        if (currentlift <= 0){
  ...
  showFuelBar() {
   ...
   handleObstacleColision(index){
    ...
    cars[index-1].collide(obstaculo2)){
